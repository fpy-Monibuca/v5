...
func (gb *GB28181Plugin) GetDeviceAlarm(ctx context.Context, req *pb.GetDeviceAlarmRequest) (resp *pb.DeviceAlarmResponse, err error) {
...
// GetSnap 实现抓拍功能
func (gb *GB28181Plugin) GetSnap(ctx context.Context, req *pb.GetSnapRequest) (resp *pb.SnapResponse, err error) {
...
// TestSip 实现测试SIP连接功能
func (gb *GB28181Plugin) TestSip(ctx context.Context, req *pb.TestSipRequest) (resp *pb.TestSipResponse, err error) {
	...
	//    [Resent Packet: False]
	// 初始化SIP客户端
	device.client, _ = sipgo.NewClient(gb.ua, sipgo.WithClientLogger(zerolog.New(os.Stdout)), sipgo.WithClientHostname("192.168.61.76"))
	...
	sdpInfo := []string{
		"v=0",
		fmt.Sprintf("o=%s 0 0 IN IP4 %s", "34020000001320000102", "192.168.61.76"),
		"s=Play",
		"c=IN IP4 192.168.61.76",
		"t=0 0",
...
func (gb *GB28181Plugin) SearchAlarms(ctx context.Context, req *pb.SearchAlarmsRequest) (resp *pb.SearchAlarmsResponse, err error) {
...
func (gb *GB28181Plugin) AddPlatformChannel(ctx context.Context, req *pb.AddPlatformChannelRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
// Recording 实现录制控制功能
func (gb *GB28181Plugin) Recording(ctx context.Context, req *pb.RecordingRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
func (gb *GB28181Plugin) UploadJpeg(ctx context.Context, req *pb.UploadJpegRequest) (resp *pb.BaseResponse, err error) {
...
func (gb *GB28181Plugin) PlaybackPause(ctx context.Context, req *pb.PlaybackPauseRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
func (gb *GB28181Plugin) PlaybackResume(ctx context.Context, req *pb.PlaybackResumeRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
// PlaybackSeek 实现回放拖动功能 暂未实现
func (gb *GB28181Plugin) PlaybackSeek(ctx context.Context, req *pb.PlaybackSeekRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
func (gb *GB28181Plugin) PlaybackSpeed(ctx context.Context, req *pb.PlaybackSpeedRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
// 当pid为空或为-1时，返回所有分组
func (gb *GB28181Plugin) GetGroups(ctx context.Context, req *pb.GetGroupsRequest) (resp *pb.GroupsListResponse, err error) {
	var groups []*pb.Group
...
// AddGroup 实现添加分组功能
func (gb *GB28181Plugin) AddGroup(ctx context.Context, req *pb.Group) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
func (gb *GB28181Plugin) UpdateGroup(ctx context.Context, req *pb.Group) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
func (gb *GB28181Plugin) DeleteGroup(ctx context.Context, req *pb.DeleteGroupRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
func (gb *GB28181Plugin) AddGroupChannel(ctx context.Context, req *pb.AddGroupChannelRequest) (resp *pb.BaseResponse, err error) {
	if gb.DB == nil {
...
func (gb *GB28181Plugin) GetGroupChannels(ctx context.Context, req *pb.GetGroupChannelsRequest) (resp *pb.GroupChannelsResponse, err error) {
...
func (gb *GB28181Plugin) RemoveDevice(ctx context.Context, req *pb.RemoveDeviceRequest) (resp *pb.BaseResponse, err error) {
	resp = &pb.BaseResponse{}
...
// OpenRTPServer 开启rtp server
func (gb *GB28181Plugin) OpenRTPServer(ctx context.Context, req *pb.OpenRTPServerRequest) (resp *pb.OpenRTPServerResponse, err error) {
